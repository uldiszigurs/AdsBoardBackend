...
router.get('/:postid',asyncMiddleware(postController.getPost));
...
router.get('/users/:username/comments', asyncMiddleware(postController.getAllCommentsForPost)); /* not sure if this should be here, 
